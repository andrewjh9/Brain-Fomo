...
from res_norm_ema_quantizer import ResidualQuantizer
...
class VQNSP(nn.Module):
    def __init__(self,
        ...
        if res_quant:
            self.quantize = ResidualQuantizer(
                num_quantizers=num_quantizers,  # choose as needed
                n_embed=n_embed,
            ...
            print("Not using residual quantizer")
    ...
    def get_tokens(self, data, input_chans=None, **kwargs):
        ...
        if 'res_quant' in kwargs:
            output['token'] = embed_ind.flatten(1)
