...
if not os.path.exists("scratch-shared/scur0546/data/TUEV"):
    os.makedirs("scratch-shared/scur0546/data/TUEV")
    print("Created folder: scratch-shared/scur0546/data/TUEV")
else:
    print("Folder exists: scratch-shared/scur0546/data/TUEV")

if not os.path.exists("scratch-shared/scur0546/data/TUEV/tuh_eeg_events"):
    os.makedirs("scratch-shared/scur0546/data/TUEV/tuh_eeg_events")
    print("Created folder: scratch-shared/scur0546/data/TUEV/tuh_eeg_events")
else:
    print("Folder exists: scratch-shared/scur0546/data/TUEV/tuh_eeg_events")

if not os.path.exists("scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1"):
    os.makedirs("scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1")
    print("Created folder: scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1")
else:
    print("Folder exists: scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1")

if not os.path.exists("scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1/edf"):
    os.makedirs("scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1/edf")
    print("Created folder: scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1/edf")
else:
    print("Folder exists: scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1/edf")

print("All folders checked and ready!\n")

OUTPUT_PATH = "scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1/edf/"
