...
def get_args():
    ...
    parser.add_argument('--res_quant', action='store_true', help='use residual quantizer')
...
def get_model(args, **kwargs):
    model = create_model(
        ...
        res_quant=args.res_quant,
    )
    return model
def get_dataset():
    train_dataset, test_dataset, val_dataset = utils.prepare_TUEV_dataset(
        "/scratch-shared/scur0546/data/TUEV/tuh_eeg_events/v2.0.1/edf/processed/")
...
def main(args):
    ...
    train_dataset, test_dataset, val_dataset, ch_names, metrics = get_dataset()
    ...
    # val_ch_names_list.append(ch_names_tuev)
