...
def get_args():
    ...
    parser.add_argument('--dataset', default='TUAB', type=str,
                        help='dataset: TUAB | TUEV | SEED-V | BCI2a')
...
def get_dataset(args):
    if args.dataset == 'TUAB':
        train_dataset, test_dataset, val_dataset = utils.prepare_TUAB_dataset("/path/to/TUAB/dataset/")
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_TUEV_dataset("/path/to/TUEV/dataset/")
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_SEEDV_dataset("/path/to/SEED-V/dataset/")
