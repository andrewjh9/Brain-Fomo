...
# root = "original_code/data/TUEV/tuh_eeg_events/v2.0.1/edf/"

INPUT_PATH = "home/scur0546/original_code/data/TUEV/tuh_eeg_events/v2.0.1/edf/"
...
if not os.path.exists("scratch-shared/scur0546/data/TUEV_v2"):
    os.makedirs("scratch-shared/scur0546/data/TUEV_v2")
    print("Created folder: scratch-shared/scur0546/data/TUEV_v2")
else:
    print("Folder exists: scratch-shared/scur0546/data/TUEV_v2")

if not os.path.exists("scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events"):
    os.makedirs("scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events")
    print("Created folder: scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events")
else:
    print("Folder exists: scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events")

if not os.path.exists("scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1"):
    os.makedirs("scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1")
    print("Created folder: scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1")
else:
    print("Folder exists: scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1")

if not os.path.exists("scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1/edf"):
    os.makedirs("scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1/edf")
    print("Created folder: scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1/edf")
else:
    print("Folder exists: scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1/edf")

print("All folders checked and ready!\n")

OUTPUT_PATH = "scratch-shared/scur0546/data/TUEV_v2/tuh_eeg_events/v2.0.1/edf/"
print(f"OUTPUT PATH: {OUTPUT_PATH}\n")

train_out_dir = os.path.join(OUTPUT_PATH, "processed_train")
eval_out_dir = os.path.join(OUTPUT_PATH, "processed_eval")
if not os.path.exists(train_out_dir):
    os.makedirs(train_out_dir)
if not os.path.exists(eval_out_dir):
    os.makedirs(eval_out_dir)

BaseDirTrain = os.path.join(INPUT_PATH, "train")
fs = 200
...
BaseDirEval = os.path.join(INPUT_PATH, "eval")
fs = 200
